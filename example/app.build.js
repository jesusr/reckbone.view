...
var View = function () {
  ...
  _createClass(View, [{
    ...
    value: function initialize(options) {
      if (_overscore2.default.isUndefined(this.template)) {
        return;
      } else {
...
class Overscore {
   ...
   */
  static extend() {
    return __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend.apply(this, arguments);
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Overscore);
