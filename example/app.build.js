...
var _reckbone = __webpack_require__(5);

var _reckbone2 = _interopRequireDefault(_reckbone);
...
var _reckbone = __webpack_require__(6);
...
function addComp(comps) {
  if (comps.indexOf('View') > -1) this.View = _reckbone2.default;
}
...
var _overscore = __webpack_require__(24);

var _overscore2 = _interopRequireDefault(_overscore);
...
var View = function () {
  function View() {
    ...
    this.template = this.template ? this.template : opt.template ? _overscore2.default.template(opt.template) : null;
  ...
  _createClass(View, [{
    ...
    value: function initialize(options) {
      if (!this.template) {
        ...
        if (this.opt.container) this.opt.container.append(this.render().el);else if (this.opt.isChild) this.render();
        this.delegateEvents();
      }
    }
  }, {
    ...
    value: function delegateEvents() {
      ...
      for (i = 0; i < keys.length; i++) {
        ...
        this.eventsRef.push((0, _jquery2.default)(document).on(arr.shift(), getSelector.call(this, arr), this[this.events[keys[i]]].bind(this)));
      }
      this.customEventDelegation();
    }
  }, {
    key: 'customEventDelegation',
    value: function customEventDelegation() {
      // to be extended
    }
  }, {
    key: 'hide',
    ...
    key: 'cleanEvents',
    value: function cleanEvents() {
      _overscore2.default.map(this.eventsRef, function (o) {
        o.off();
      });
      this.eventsRef = [];
    }
    ...
    value: function extend(protoProps, staticProps) {
      var parent = this;
      var child = void 0;
      if (protoProps && _overscore2.default.has(protoProps, 'constructor')) {
      ...
      _overscore2.default.extend(child, parent, staticProps);
      child.prototype = _overscore2.default.create(parent.prototype, protoProps);
...
function getSelector(arr) {
  var selector = '#' + this.$el.parent.id;
...
function registerTemplate() {
  /* istanbul ignore next */
  if (!_overscore2.default.isUndefined(this.templatePartials)) {
    for (var partialName in this.templatePartials) {
      if (!this.templatePartials.hasOwnProperty(partialName)) {
        continue;
      }
      _runtime2.default.default.registerPartial(partialName, this.templatePartials[partialName]);
    }
  }
}

function _getTemplateConfig() {
  var keys = Object.keys(this.exTemplateConfig);
  var aux = {};
  for (var i = 0; i < keys.length; i++) {
    aux[keys[i]] = this.exTemplateConfig[keys[i]];
  }
  this.templateConfig = _overscore2.default.extend({}, aux);
}
...
function _setElement(el) {
  this.$el = typeof el === 'string' || el instanceof String ? (0, _jquery2.default)(el) : el;
  this.el = this.$el[0];
  return this;
}
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		define("overscore", [], factory);
	else if(typeof exports === 'object')
		exports["overscore"] = factory();
	else
		root["overscore"] = factory();
})(this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
/******/ 	var installedModules = {};
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /*jshint -W116 */
...
var getLength = void 0,
    property = void 0,
    createAssigner = void 0,
    collectNonEnumProps = void 0,
    createEscaper = void 0;
var MAXthisARRAYthisINDEX = Math.pow(2, 53) - 1;

/** Class Overscore, replacement for Underscore. */

var Overscore = function () {
  function Overscore() {
    _classCallCheck(this, Overscore);
  }

  _createClass(Overscore, null, [{
    key: 'isObject',
    ...
    value: function extend() {
      return _jquery2.default.extend.apply(this, arguments);
    }
    ...
    key: 'create',
    value: function create(prototype, props) {
      var _this = this,
          Ctor = function Ctor() {};

      function baseCreate(prototype) {
        if (!_this.isObject(prototype)) {
          return {};
        }
        if (Object.create) {
    ...
    value: function keys(obj) {
      ...
      if (hasEnumBug) {
        collectNonEnumProps.call(this, obj, keys);
      }
      return keys;
    }
    ...
    key: 'reduce',
    value: function reduce(obj, iteratee, memo, context) {
    ...
    key: 'sortBy',
    value: function sortBy(obj, iteratee, context) {
    ...
    key: 'uniqBy',
    value: function uniqBy(arr, iteratee) {
      ...
      if (typeof iteratee === 'function') {
        var _f = [];
        return arr.filter(function (n) {
          return _f.indexOf(iteratee(n)) == -1 && _f.push(iteratee(n));
        });
      }
    ...
    key: 'pluck',
    value: function pluck(obj, key) {
      return this.map(obj, property(key));
    }
  }, {
    key: 'iterator',
    value: function iterator(obj, iteratee, memo, keys, index, length) {
    ...
    key: 'optimizeCb',
    value: function optimizeCb(func, context, argCount) {
      if (context === void 0) {
        return func;
      }
    ...
    key: 'cb',
    value: function cb(value, context, argCount) {
      if (value === null) {
    ...
    key: 'template',
    value: function template(text, settings) {
      ...
      var template = void 0,
        ...
        '\u2029': 'u2029'
          ...
          matcher = RegExp([(settings.escape || /(.)^/).source, (settings.interpolate || /(.)^/).source, (settings.evaluate || /(.)^/).source].join('|') + '|$', 'g'),
          index = 0,
          source = '__p+=\'';
...
createAssigner = function createAssigner(keysFunc, undefinedOnly) {
  return function (obj) {
...
collectNonEnumProps = function collectNonEnumProps(obj, keys) {
  var nonEnumerableProps = ['valueOf', 'isPrototypeOf', 'toString', 'propertyIsEnumerable', 'hasOwnProperty', 'toLocaleString'],
      ...
      prop = 'constructor';
  if (this.has(obj, prop) && !this.contains(keys, prop)) {
    keys.push(prop);
  }
  while (nonEnumIdx--) {
...
createEscaper = function createEscaper(map) {
